...
def top_content(file_reference,di):
    '''
    Countries producing the most contents.
    Parameters:
    -------------
    df : DataFrame
    ...
    # h = html(chart._repr_html_(),width=500, height=500)
    return html(chart._repr_html_(),width=500, height=500)
...
with col1.container():
    ...
    # chart = top_content(country_counting)
    top_content(file_reference,country_counting)
